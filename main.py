...
# Гипотеза 4: Книга с номером 1 существует
# Способ проверки: поставить число 1 после token во вложенной функции
# Код для проверки: print(get_author(get_book_by_id(1, 'AAECTkuGjWo1Imwr-_6UrN-nzbo89sd3WSM')))
# Установленный факт: книга не существует, т.к. код выводит ошибку 404 в консоле
...
# Установленный факт: книга существует, код выводит автора в консоле после переставления аргументов
