...
# Способ проверки: методом клика пройтись по кажой скобке
...
# Гипотеза 4: Книги с номером 1 существует
...
# Установленный факт: книга существует, т.к. код выводит автора на консоль
# Вывод: проблема в порядке аргументов